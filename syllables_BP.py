"""
Code from Michał Woźniak, email: m.wozniak60@student.uw.edu.pl,
with a small adjustment from Magdalena Borysiak in the count_word function
"""
...
def count_word(word):
    ...
    # added this if below to ensure that a word is first looked up in the cmudict - MB
    if word.lower() in d:
        return nsyl(word)[0]
